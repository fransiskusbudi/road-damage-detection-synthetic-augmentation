...
# ====================
source /home/${USER}/miniconda3/bin/activate yolop
...
python test.py --weight /home/USER/road_detection/weights/yolop-640-640.onnx --img_dir bdd_selected_540/images --output_dir bdd_selected_540/mask
